...
export class QuizComponent implements OnInit {
  ...
  questions : Question[] = [
    ...
    {id: "3b", group: "3", text: "What's your go-to snack?", answer: "Ants on a log", points: 1, gender: "" },
    {id: "3c", group: "3", text: "What's your go-to snack?", answer: "Flaming Hot Cheetos", points: 10, gender: "" },
    {id: "4a", group: "4", text: "Which color wheel describes your vibe?", answer: "Green and blue", points: 5, gender: "" },
    {id: "4b", group: "4", text: "Which color wheel describes your vibe?", answer: "Red and black", points: 10, gender: "" },
    {id: "4c", group: "4", text: "Which color wheel describes your vibe?", answer: "Pink and purple", points: 1, gender: "" },
    {id: "5a", group: "5", text: "What's your favorite way to get around?", answer: "Drive, duh", points: 3, gender: "" },
    {id: "5b", group: "5", text: "What's your favorite way to get around?", answer: "Fly through the sky", points: 2, gender: "" },
    {id: "5c", group: "5", text: "What's your favorite way to get around?", answer: "Teleport...of course", points: 1, gender: "" },
